...
INSERT INTO Books (title, author, ISBN, cover, publishingDate, publisher) VALUES ('Daisy Jones & the Six', 'Taylor Jenkins Reid', '9781524798628 ', '\images\Daisy-Jones-and-the-Six.jpg', '2019-03-05', 'Ballantine Books');
INSERT INTO Books (title, author, ISBN, cover, publishingDate, publisher) VALUES ('The Midnight Library', 'Matt Haig', '9780525559474', '\images\The-Midnight-Library.jpg', '2020-09-29', 'Viking');
INSERT INTO Books (title, author, ISBN, cover, publishingDate, publisher) VALUES ('The Song of Achilles', 'Madeline Miller', '9781408816035', '\images\The-Song-of-Achilles.jpg', '2011-09-20', 'Bloomsbury Publishing');
INSERT INTO Books (title, author, ISBN, cover, publishingDate, publisher) VALUES ('Vinland Saga Omnibus, Vol. 1', 'Makoto Yukimura', '9781612624204', '\images\Vinland-Saga-volume-1.jpg', '2013-10-14', 'Kodansha Comics');
INSERT INTO Books (title, author, ISBN, cover, publishingDate, publisher) VALUES ('Lessons in Chemistry', 'Bonnie Garmus', '9780593314487', '\images\LessonsInChemistry.jpg', '2022-04-05', 'Doubleday');
INSERT INTO Books (title, author, ISBN, cover, publishingDate, publisher) VALUES ('The Poppy War', 'R.F. Kuang', '9780062662590 ', '\images\PoppyWarCover.jpg', '2018-05-1', 'Harper Voyager');
INSERT INTO Books (title, author, ISBN, cover, publishingDate, publisher) VALUES ('Tress of the Emerald Sea', 'Brandon Sanderson', '9781250899651', '\images\TressOfTheEmeraldSea.jpg', '2023-04-04', 'Tor Books');
INSERT INTO Books (title, author, cover) VALUES ('Aesop''s Fables', 'Aesop', '\images\Aesops-Fables.jpg');
